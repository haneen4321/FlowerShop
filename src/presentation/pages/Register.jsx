        ...
        <div className="auth-form">
          ...
          {password && (
            <div className="password-rules">
              {!passwordRules.minLength && (<p>{t.role_1}</p>)}
              {!passwordRules.hasUpperCase && (<p>{t.role_2}</p>)}
              {!passwordRules.hasLowerCase && (<p>{t.role_3}</p>)}
              {!passwordRules.hasNumber && (<p>{t.role_4}</p>)}
            </div>
          )}
          <button className="auth-btn" onClick={handleRegister}>{t.register}</button>
          <div className="auth-footer">{t.have_account}{" "}
